  ...
  const MapsData = [
    {
      ...
      details: "Kalau kamu tertarik dengan APA YA. "+capitalize(router.query.mapsID)+" Camp cocok menjadi tempat singgah kamu.",
    },
    {
      bgImg: "/mapsItem2.png",
      bgImg2: "/mapsItem1_mobile.png",
    ...
    {
      bgImg: "/mapsItem10.png",
      bgImg2: "/mapsItem1_mobile.png",
      title: capitalize(router.query.mapsID),
      details: "Kalau kamu tertarik dengan APA YA. "+capitalize(router.query.mapsID)+" Camp cocok menjadi tempat singgah kamu.",
    },
    {
      bgImg: "/mapsItem11.png",
      bgImg2: "/mapsItem1_mobile.png",
      title: capitalize(router.query.mapsID),
      details: "Kalau kamu tertarik dengan APA YA. "+capitalize(router.query.mapsID)+" Camp cocok menjadi tempat singgah kamu.",
    },
    {
      bgImg: "/mapsItem12.png",
      bgImg2: "/mapsItem1_mobile.png",
      title: capitalize(router.query.mapsID),
      details: "Kalau kamu tertarik dengan APA YA. "+capitalize(router.query.mapsID)+" Camp cocok menjadi tempat singgah kamu.",
    },
    {
      bgImg: "/mapsItem13.png",
      bgImg2: "/mapsItem1_mobile.png",
      title: capitalize(router.query.mapsID),
      details: "Kalau kamu tertarik dengan APA YA. "+capitalize(router.query.mapsID)+" Camp cocok menjadi tempat singgah kamu.",
    },
