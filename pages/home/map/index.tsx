...
const Maps = (props: any) => {
  ...
  return (
    <Layout>
      <Flex
        className={"maps"}
        width={isLargerThan1900 ? "215vh" : ["1920px", "1920px", "1920px", "1523px", "1523px"]}
      ...
      >
        <Header />
            <Link href={`/home/map/chapter/${chapter[0]?.name}`}>
                <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "17.5rem" : ["23.5rem", "23.5rem", "12.5rem", "9rem", "9rem"]} mt={isLargerThan1900 ? "223.2rem" : ["305rem", "305rem", "157.5rem", "122rem", "122rem"]} cursor={"pointer"}>
                    <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[1]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "49rem" : ["64rem", "64rem", "35rem", "27.5rem", "27.5rem"]} mt={isLargerThan1900 ? "210rem" : ["298rem", "298rem", "148rem", "115.5rem", "115.5rem"]} cursor={"pointer"}>
            <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[2]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "76rem" : ["88.5rem", "88.5rem", "55rem", "42rem", "42rem"]} mt={isLargerThan1900 ? "207rem" : ["285rem", "285rem", "146rem", "115rem", "115rem"]} cursor={"pointer"}>
            <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[3]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "96rem" : ["35rem", "35rem", "68rem", "52rem", "52rem"]} mt={isLargerThan1900 ? "203rem" : ["266rem", "266rem", "143rem", "111rem", "111rem"]} cursor={"pointer"}>
            <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[4]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "130rem" : ["58rem", "58rem", "90rem", "69.5rem", "69.5rem"]} mt={isLargerThan1900 ? "197rem" : ["240rem", "240rem", "140rem", "109rem", "109rem"]} cursor={"pointer"}>
            <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[5]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "158rem" : ["90rem", "90rem", "110.5rem", "86.2rem", "86.2rem"]} mt={isLargerThan1900 ? "183rem" : ["222rem", "222rem", "128.5rem", "99rem", "99rem"]} cursor={"pointer"}>
            <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[6]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "134.5rem" : ["58rem", "58rem", "95.6rem", "74.3rem", "74.3rem"]} mt={isLargerThan1900 ? "160rem" : ["205rem", "205rem", "114.5rem", "88rem", "88rem"]} cursor={"pointer"}>
            <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[7]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "103.9rem" : ["28.5rem", "28.5rem", "73rem", "56.6rem", "56.6rem"]} mt={isLargerThan1900 ? "158rem" : ["202rem", "202rem", "112.5rem", "86.5rem", "86.5rem"]} cursor={"pointer"}>
            <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[8]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "33rem" : ["69rem", "69rem", "23.5rem", "18rem", "18rem"]} mt={isLargerThan1900 ? "138.5rem" : ["156rem", "156rem", "97.5rem", "75rem", "75rem"]} cursor={"pointer"}>
            <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[9]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "28rem" : ["38.2rem", "38.2rem", "19rem", "14.5rem", "14.5rem"]} mt={isLargerThan1900 ? "113rem" : ["133rem", "133rem", "81rem", "62rem", "62rem"]} cursor={"pointer"}>
            <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[10]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "64.5rem" : ["16rem", "16rem", "45em", "34.5rem", "34.5rem"]} mt={isLargerThan1900 ? "102rem" : ["107rem", "107rem", "72.5rem", "55.5rem", "55.5rem"]} cursor={"pointer"}>
            <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[11]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "97rem" : ["44rem", "44rem", "68rem", "52.5rem", "52.5rem"]} mt={isLargerThan1900 ? "79rem" : ["77rem", "77rem", "55.5rem", "42rem", "42rem"]} cursor={"pointer"}>
            <Center>
        ...
        <Link href={`/home/map/chapter/${chapter[12]?.name}`}>
          <Box _hover={{ transform: "scale(1.1)", transition: "0.5s" }} position={"absolute"} ms={isLargerThan1900 ? "64.5rem" : ["13rem", "13rem", "46rem", "35.5rem", "35.5rem"]} mt={isLargerThan1900 ? "55rem" : ["16rem", "16rem", "39.5rem", "30rem", "30rem"]} cursor={"pointer"}>
            <Center>
